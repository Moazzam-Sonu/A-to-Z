...
## Halo 1.1.9 (06-03-2024)
- Fixed quick search.

## Halo 1.1.8 (29-02-2024)
- Fixed minor bugs.
...
## Halo 1.1.7 (20-10-2023)
- Fixed minor bugs.

## Halo 1.1.6 (13-10-2023)
...
## Halo 1.1.5 (06-28-2023)
- Add Home Tech

## Halo 1.1.4 (06-16-2023)
- Update contact with author

## Halo 1.1.3 (12-26-2022)
- Update Code Preload/Early Hints.
- Update micro data schema.
- Update Code Sticky Add To Cart Function.
- Update Code Page Builder.
- Fixed minor bugs.

## Halo 1.1.2 (07-14-2022)
- Update quick view as requested by Bigcommerce.

## Halo 1.1.1 (12-24-2021)
- Fixed: the product in the bundle product list with the first variant is out of stock, the bundle function does not work.

## Halo 1.1.0 (11-23-2021)
- Fixed the Calculate Free Shipping function that hides the promotional messages on the cart page.

## Halo 1.0.9 (11-17-2021)
- Update meta images for Home 2

## Halo 1.0.8 (11-05-2021)
- Added New Home: Shopica

## Halo 1.0.7 (09-13-2021)
- Updated checkout page

## Halo 1.0.6 (09-08-2021)
- Removed 25% discount on Marketplace

## Halo 1.0.5 (06-02-2021)
- Added 25% discount on Marketplace

## Halo 1.0.4 (06-02-2021)
- Fixed: minor bugs

## Halo 1.0.3 (06-02-2021)
- Fixed image logo will overlap navigation menu if size exceeds a certain max height in page builder settings

## Halo 1.0.2 (04-13-2021)
- Updated Caculate Free Shipping function (allow store owners to set up in Theme Editor not in Script Manager)
- Updated theme with ADA compliance
- Updated Shipping Tab + Return Tab on product detail page (get content of the tab from webpage)
- Updated Block Custom HTML (get content of the tab from webpage)
- Move slick code from Marketing Banner and Webpage to js file
